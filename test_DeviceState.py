...
class TestDeviceState(TestCase):
    def test_int2bit_1(self):
        self.assertEqual([0, 0, 0, 0, 0, 0, 0, 1], DeviceState.int2bits(1))

    def test_int2bit_16(self):
        self.assertEqual([0, 0, 0, 1, 0, 0, 0, 0], DeviceState.int2bits(16))

    def test_int2bit_170(self):
        self.assertEqual([1, 0, 1, 0, 1, 0, 1, 0], DeviceState.int2bits(170))

    def test_parse_1(self):
        state = DeviceState()
        enc = [170, 170, 18, 1, 10, 10, 0, 12, 7, 0, 196, 0, 0, 0, 0, 22, 5, 0, 0, 0, 109]
    ...
    def test_parse_2(self):
        state = DeviceState()
        enc = [170, 170, 18, 0, 10, 10, 0, 4, 6, 0, 196, 0, 0, 0, 60, 22, 0, 0, 0, 0, 154]
